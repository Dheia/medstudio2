...
class BuilderTableUpdateKonvertagencyDoctors8 extends Migration
{
    public function up()
    {
        Schema::table('konvertagency_doctors_', function($table)
        {
            ...
            $table->string('view_page', 191)->default('vrachi')->change();
        });
    }
    ...
    public function down()
    {
        Schema::table('konvertagency_doctors_', function($table)
        {
            ...
            $table->text('description')->default('NULL')->change();
            $table->string('slug', 191)->default('\'null\'')->change();
            $table->string('view_page', 191)->default('\'all, vrachi\'')->change();
        });
    }
}
